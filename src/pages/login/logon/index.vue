<template>
    <div class="LoginMain">
        ...
        <div class="Login_ Login_left">
            ...
            <svg class="Login_bottom" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="869.99994"
                height="520.13854" viewBox="0 0 869.99994 520.13854" xmlns:xlink="http://www.w3.org/1999/xlink">
                <path
                ...
                <circle cx="524.99994" cy="335.5" r="16" fill="#005bac" />
                ...
                <path
                    ...
                    transform="translate(-165.00003 -189.93073)" fill="#005bac" />
                <path
        ...
        <!-- 登录右侧 -->
        <div class="Login_ Login_right">
            <img src="@/assets/login/登录.png" style="margin-top: 40px;" alt="logo"  />
            <el-form :model="loginFormInfo" ref="login" class="Login_form" :rules="rules" label-position="left">
                <el-form-item prop="userName">
                    <el-input placeholder="账号" prefix-icon="el-icon-user" class="logon_info"
